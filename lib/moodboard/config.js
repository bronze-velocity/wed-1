...
export const MOMENTS = [
  { id: 'cocktail', label: 'Cocktail hour', description: 'Unlock a story while guests explore.', appIds: ['venue-scavenger-hunt', 'unpopular-opinions', 'first-look-voice-letter'] },
...
export const FEELINGS = [
  { id: 'cry-good-kind', label: 'Cry (the good kind)', description: 'Real voices become a private keepsake.', appIds: ['video-guestbook', 'anniversary-time-capsule', 'first-look-voice-letter'] },
  ...
  { id: 'keepsake-from-everyone', label: 'A keepsake from everyone', description: 'Small contributions become something worth keeping.', appIds: ['advice-oracle', 'video-guestbook', 'first-look-voice-letter', 'where-next-map'] },
